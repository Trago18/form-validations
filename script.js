...
const fname = document.getElementById("validationFirstName");
const lname = document.getElementById("validationLastName");
const city = document.getElementById("validationCity");
const state = document.getElementById("validationState");
const zip = document.getElementById("validationPostalCode");
...
form.addEventListener('submit', (e) => {
    ...
    if (zip.value === '' || zip.value == null) {
        document.querySelector("#validationPostalCode").style.background = "#ffe6e6";
        ...
        document.querySelector("#validationPostalCode").style.background = "#f2ffe5";
        let x = document.querySelectorAll("#zip")[0].children.length;
        if (x == 3) {
